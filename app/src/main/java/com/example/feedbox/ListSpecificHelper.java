...
public class ListSpecificHelper {
    ...
    public ListSpecificHelper(int spc_d_ID, String spc_d_Cat, String spc_d_Name, String sc_name, String cat_name, int sc_id, int cat_id ) {
        Spc_d_ID = spc_d_ID;
        Spc_d_Cat = spc_d_Cat;
        Spc_d_Name = spc_d_Name;
        Sc_Name = sc_name;
